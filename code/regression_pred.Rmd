...
We will calculate the neural features for the alpha, beta, and gamma frequency bands.
...
We will run the forward/backward model to find the best neural features that predict reaction time.
