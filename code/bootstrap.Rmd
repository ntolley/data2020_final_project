...
df_alpha <- read_csv(file.path(directory, "../data/alpha_event_data.csv"), show_col_types = FALSE)
df_beta <- read_csv(file.path(directory, "../data/beta_event_data.csv"), show_col_types = FALSE)
df_gamma <- read_csv(file.path(directory, "../data/gamma_event_data.csv"), show_col_types = FALSE)
